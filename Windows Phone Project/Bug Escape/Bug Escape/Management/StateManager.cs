...
namespace Bug_Escape.Management
{
    ...
    public class StateManager : DrawableGameComponent
    {
        ...
        public static bool HasAudioControl;
        ...
        public StateManager(Game game) : base(game)
        {
            ...
            PathForRecords = "BugEscape_Records.xml";
        ...
        public void GoToGameOver(float Score)
        {
            NextState = GameStates.GameOver;
            IsOnTransition = true;
            States.Add(GameStates.GameOver, new GameOver(this , Score));
        ...
        public static string PathForPreferences { get; set; }
    }
}