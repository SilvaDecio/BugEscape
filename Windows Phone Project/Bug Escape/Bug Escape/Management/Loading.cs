...
namespace Bug_Escape.Management
{
    public class Loading : State
    {
        ...
        public Loading(StateManager Father)
        {
            ...
            Animation = new Sprite(Manager.Game.Content.Load<Texture2D>("Loading"), 99f, "Loading.txt", "Loading");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Animation.Draw(Manager.spriteBatch, new Vector2(275 , 200));
