...
namespace Decio.Collision
{
    class AngulatedRectangle
    {
        ...
        public AngulatedRectangle(Rectangle theRectangle, float theInitialRotation)
        {
        ...
        {
            Origin = new Vector2((int)CollisionRectangle.Width / 2,
                (int)CollisionRectangle.Height / 2);
        }
        ...
        {
            return Intersects(new AngulatedRectangle(theRectangle, 0.0f));
        }
        ...
        /// <param name="theRectangle"></param>
        /// <returns></returns>
        public bool Intersects(AngulatedRectangle theRectangle)
        {
        ...
        /// <returns></returns>
        private bool IsAxisCollision(AngulatedRectangle theRectangle, Vector2 aAxis)
        {
        ...
        public int X
        {
            ...
            set { CollisionRectangle.X = value; }
        }
        ...
        public int Y
        {
            ...
            set { CollisionRectangle.Y = value; }
        }
